title: 使用 gulp 压缩 JS
date: 2016-09-06 11:23:54 +0800
update: 2016-09-06 12:00:00 +0800
author: me
tags:
    - Gulp
preview: 压缩 js 代码可降低 js 文件大小，提高页面打开速度。在不利用 gulp 时我们需要通过各种工具手动完成压缩工作。所有的 gulp 代码编写都可以看做是将规律转化为代码的过程。
